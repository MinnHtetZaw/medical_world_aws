...
{{--                                <td>{{ $unit->gender_id }}</td>--}}
                                ...
                                <div class="modal fade" id="show_spec{{$unit->id}}" role="dialog" aria-hidden="true">
                                    ...
                                    <div class="modal-body">
                                        <form class="form-material" method="post" action="{{ route('count_unit_update_spec',$unit->id)}}">
                                            @csrf
                                                ...
                                                <div class="form-group col-12">
                                                    ...
                                                    <input class="col-6 form-control mb-3" name="unit_name" value="{{$unit->unit_name}}" placeholder="Enter Unit Name">
                                                    ...
                                                    <div class="row form-group">
                                                        ...
                                                        <div class="col-6">
                                                            <select class="form-control" name="design_id">
                                                                <option value=" {{$unit->design->id}}" selected>
                                                                    {{$unit->design->design_name ?? 'Design Name'}}
                                                                </option>
                                ...
                                {{--                    Fabric Salect--}}
                                                    <div class="row form-group">
                                                        ...
                                                        <div class="col-6">
                                                            ...
                                                            <select class="form-control " id="" name="fabric_id">
                                                                <option value=" {{$unit->fabric->id}}" selected>
                                                                    {{$unit->fabric->fabric_name ?? 'Fabric Name'}}
                                                                </option>
                                ...
                                {{--                    Colour Salect--}}
                                                    <div class="row form-group">
                                                        ...
                                                        <div class="col-6">
                                                            ...
                                                            <select class="form-control " id="" name="colour_id">
                                                                <option value=" {{$unit->colour->id}}" selected>
                                                                    {{$unit->colour->colour_name ?? 'Colour Name'}}
                                                                </option>
                                                    ...
                                                    <div class="row form-group">
                                                        ...
                                                        <div class="col-6">
                                                            ...
                                                            <select class="form-control " name="size_id" id="">
                                                                <option value=" {{$unit->size->id}}" selected>
                                                                    {{$unit->size->size_name ?? 'Size Name'}}
                                                                </option>
                                                    ...
                                                    <div class="row form-group">
                                                        ...
                                                        <div class="col-6">
                                                            <select class="form-control " name="gender_id">
                                                                <option value=" {{$unit->gender->id}}" selected>
                                                                    {{$unit->gender->gender_name ?? 'Gender'}}
                                                                </option>
