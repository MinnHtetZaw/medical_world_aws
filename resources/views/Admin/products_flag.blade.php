                        ...
                        <tbody id="units_table">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <input type="checkbox" class="newarrck" style="width: 50px; position: relative; left: 0; opacity: 1;" data-newarrckid="newarrck{{$unit->id}}" id="newarrck{{$unit->id}}" data-id="{{$unit->id}}" value="0" checked>
                                        @else
...
<script>
    ...
    $('#units_table').on('keypress','.hotck',function(){
        ...
        if(keycode=='13'){
            ...
            // var chek_value = $(this).val();
            var unit_id= $(this).data('id');
            var promockid = $(this).data('hotckid');
            $.ajax({

                type:'POST',

                url:'{{route('hotcheckon-ajax')}}',
