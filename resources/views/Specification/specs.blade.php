                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <div class="btn-group-sm">
                                                ...
                                                <a href="{{route('design.delete',$design->id)}}" class="btn btn-outline-primary">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <div class="btn-group-sm">
                                                        ...
                                                        <a href="{{route('fabric.delete',$fabric->id)}}" class="btn btn-outline-primary" title="Delete Button">
                                                            <i class="fas fa-trash-alt"></i>
                                                        </a>
                                                    </div>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <div class="btn-group-sm">
                                                        ...
                                                        <a href="{{route('colour.delete',$colour->id)}}" class="btn btn-outline-primary" title="Delete Button">
                                                            <i class="fas fa-trash-alt"></i>
                                                        </a>
                                                    </div>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="btn-group-sm">
                                                        ...
                                                        <a href="{{route('size.delete',$size->id)}}" class="btn btn-outline-primary" title="Delete Button">
                                                            <i class="fas fa-trash-alt"></i>
                                                        </a>
                                                    </div>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <div class="btn-group-sm">
                                                        ...
                                                        <a href="{{route('gender.delete',$gender->id)}}" class="btn btn-outline-primary" title="Delete Button">
                                                            <i class="fas fa-trash-alt"></i>
                                                        </a>
