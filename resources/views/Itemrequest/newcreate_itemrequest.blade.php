            ...
            function count_change(id, action, qty) {
                ...
                if (action == 'qty') {
                    ...
                    // }
                        ...
                        item[0].sub_yards = qty * item[0].rolls;

                            item[0].each_sub = item[0].purchase_price * item[0].sub_yards;
                ...
                if (mycart) {
                    ...
                    if (mycartobj.length > 0) {
                        ...
                        $.each(mycartobj, function(i, v) {
                            ...
                            <td class="text-black ke w-20 m-0 p-0" onkeyup="yardplus(${id})" id="${id}">
                                <input type="number" class="form-control w-100 text-black yardkey text-center p-0 mt-1" name="" id="nowyardsperroll${id}" value="${yards_per_roll}" style="border: none;border-color: transparent;">
                            </td>
