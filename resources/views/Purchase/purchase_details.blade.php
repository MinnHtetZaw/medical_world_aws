            		...
            		<div class="col-md-8" style="margin-left:auto;margin-right:auto;">
            			...
            			<div class="table-responsive text-black">
		                    <table class="table" id="example23" >
		                        ...
		                        <tbody id="units_table">
		                            ...
		                            @foreach($purchase->factory_item as $unit)
		                                ...
		                                <tr>
		                                    <td><input class="w-2 form-check-input" type="checkbox" value="{{$unit->id}}" id="checkitem{{$unit->id}}" data-itemname="{{$unit->item_name}}" data-purchaseqty="{{$unit->pivot->quantity}}" {{$unit->pivot->arrive_complete === 1 || $purchase->adjustment_flag === 2 ? 'disabled' : ''}}>
                            <label class="w-2 form-check-label font14" for="checkitem{{$unit->id}}"></label></td>
											...
											<td class="w-25">
											    <input type="number" class="form-control w-100 arriveinput text-black" data-arriveinput="arriveinput{{$unit->id}}"  data-purchaseid="{{$purchase->id}}" id="arriveinput{{$unit->id}}" data-id="{{$unit->id}}" value="0"
                                                @if ($purchase->adjustment_flag === 2 || $unit->pivot->arrive_complete === 1)
                                                disabled
                                                @endif >
                                            ...
                                            <td class="w-25">
                                                ...
                                                @if ($purchase->adjustment_flag === 2)
                                                value= "0"
                                                @elseif ($purchase->adjustment_flag === 1)
