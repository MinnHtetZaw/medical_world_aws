    ...
    <section id="plan-features">
        ...
        <div class="row ml-2 mt-3">
            ...
            <div class="col-md-2">
                ...
                <input type="date" name="to_date" id="to_date" class="form-control" value="{{ $current_date }}"
                    required>
            </div>
            ...
            <form id="exportForm" onsubmit="return exportForm()" method="get">
                ...
                <div class="col-md-1 m-t-30">
                    <button class="btn btn-info px-4" id="export_itemadjust">Export</button>
                </div>
            </form>
...
@section('js')
    ...
    <script type="text/javascript">
        ...
        function exportForm() {
            ...
            let url = `/export_itemadjust/${from}/${to}`;
