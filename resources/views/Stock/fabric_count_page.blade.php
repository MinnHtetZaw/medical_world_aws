                        ...
                        <div class="col-md-4 m-t-10 ml-4">
                            ...
                            <select class="form-control select2" id="item_list">
                                ...
                                @foreach ($fabric_entry_items as $item)
                                    <option value="{{ $item->factory_item_id }}">
                                        {{ $item->factory_item_name ?? 'name' }}-{{ $item->instock_qty ?? 0 }}</option>
                                @endforeach
                            </select>
                        </div>

                        <div class="col-md-1 m-t-30 ml-2">
                            <button class="btn btn-success px-4" id="search_entry" data-toggle="modal"
                                data-target="#new_entry">New Entry</button>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form class="form-material m-t-40" method="post"
                                            action="{{ route('fabricentry_store') }}">
                                            @csrf
                                            <div class="form-body">
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <select style="width: 210px" name="category"
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <select style="width: 210px" name="subcategory"
                                                                class="form-control" id="subcategory"
                                                                onchange="searchCountingUnit(this.value)">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <select style="width: 210px" name="item_id" class="form-control"
                                                                id="factory_item_select">
                                                                <option value="">Factory Items</option>
                                                                @foreach ($factory_items as $item)
                                                                    <option value="{{ $item->id }}"
                                                                        data-instockqty="{{ $item->instock_qty }}">
                                                                        {{ $item->item_name }}
                                                                    </option>
                                                                @endforeach
                                                            </select>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" name="instock_qty" id="instock_qty"
                                                                class="form-control">
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="form-actions">
                                                    <div class="row">
                                                        <div class=" col-md-9">
                                                            <button type="submit"
                                                                class="btn btn-success">@lang('lang.submit')</button>
                            ...
                            <tbody id="items_table">
                                ...
                                @foreach ($fabric_entry_items as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <input type="number" class="form-control w-50 openstock text-black"
                                                data-openstockid="openstock{{ $item->factory_item_id }}"
                                                id="openstock{{ $item->factory_item_id }}"
                                                data-id="{{ $item->factory_item_id }}"value="{{ $item->instock_qty }}" disabled>
                                        </td>

                                        <td>
                                            <input type="number" class="form-control w-50 instock text-black"
                                                data-instockid="instock{{ $item->factory_item_id }}"
                                                id="instock{{ $item->factory_item_id }}"
                                                data-id="{{ $item->factory_item_id }}"value=0 disabled>
                                        </td>

                                        <td>
                                            <input type="number" class="form-control w-50 outstock text-black"
                                                data-outstockid="outstock{{ $item->factory_item_id }}"
                                                id="outstock{{ $item->factory_item_id }}"
                                                data-id="{{ $item->factory_item_id }}"value=0>
                                        </td>

                                        <td>
                                            <input type="number" class="form-control w-50 closestock text-black"
                                                data-closestockid="closestock{{ $item->factory_item_id }}"
                                        ...
                                        <td>
                                            <input type="text" class="form-control w-75 remark text-black"
                                                data-remarkid="remark{{ $item->factory_item_id }}"
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $.each(data, function(i, value) {
                            ...
                            $('#item_list').append($('<option>').text(value.item_name).attr('value', value
                                .id));
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    <tr>
                                    ...
                                    <td>
                                        <input type="number" class="form-control w-50 openstock text-black" data-openstockid="openstock${entry.factory_item_id}" id="openstock${entry.factory_item_id}" data-id="${entry.factory_item_id}"value=${entry.open_stock} disabled>
                                    </td>

                                    <td>
                                        <input type="number" class="form-control w-50 instock text-black" data-instockid="instock${entry.factory_item_id}" id="instock${entry.factory_item_id}" data-id="${entry.factory_item_id}"value=${entry.in_stock} disabled>
                                    </td>
                                    ...
                                    <td>
                                        <input type="number" class="form-control w-50 closestock text-black" data-closestockid="closestock${entry.factory_item_id}" id="closestock${entry.factory_item_id}" data-id="${entry.factory_item_id}"value=${entry.close_stock} disabled>
                                    </td>
        ...
        $('#item_list').change(function() {
            ...
            if (item_id == 0) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        if (entry.status == 1) {
                            ...
                            $('#items_table').append($('<tr>')).append($('<td>').text(1)).append($(
                                '<td>').text(entry.factory_item_name)).append($('<td>').append(
                                open_stock)).append($('<td>').append(in_stock)).append($('<td>')
                                .append(out_stock)).append($('<td>').append(close_stock)).append($(
                                '<td>').append(remark));
                ...
                var entryItem = {
                    id: entry.factory_item_id,
                    item_name: entry.factory_item_name,
                    open_stock: entry.instock_qty,
                    in_stock: 0,
                    out_stock: 0,
                    close_stock: entry.instock_qty,
                    remark: ''
                };
                myentryCartobj.push(entryItem);
                 localStorage.setItem('myentryCart', JSON.stringify(myentryCartobj));
                            let open_stock =
                                `<input type="number" class="form-control w-50 openstock text-black" data-openstockid="openstock${entry.factory_item_id}" id="openstock${entry.factory_item_id}" data-id="${entry.factory_item_id}"value=${entry.instock_qty} disabled>`;

                            let in_stock =
                                `<input type="number" class="form-control w-50 instock text-black" data-instockid="instock${entry.factory_item_id}" id="instock${entry.factory_item_id}" data-id="${entry.factory_item_id}"value=0 disabled>`;

                            let out_stock =
                                `<input type="number" class="form-control w-50 outstock text-black" data-outstockid="outstock${entry.factory_item_id}" id="outstock${entry.factory_item_id}" data-id="${entry.factory_item_id}"value=0 >`;

                            let close_stock =
                                `<input type="number" class="form-control w-50 closestock text-black" data-closestockid="closestock${entry.factory_item_id}" id="closestock${entry.factory_item_id}" data-id="${entry.factory_item_id}"value=${entry.instock_qty} disabled>`;

                            let remark =
                                `<input type="text" class="form-control w-75 remark text-black" data-remarkid="remark${entry.factory_item_id}" id="remark${entry.factory_item_id}" data-id="${entry.factory_item_id}">`;
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (data.length > 0) {
                        ...
                        $.each(data, function(i, value) {
                            $('#factory_item_select').append($('<option>').text(value.item_name).attr(
                                'value', value.id));
                        });
                    } else {
