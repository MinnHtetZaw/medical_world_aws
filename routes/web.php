...
Route::group(['middleware' => ['UserAuth']], function () {
    ...
    Route::post('factoryitem/update/{id}', 'Web\InventoryController@updatefactoryItem')->name('factoryitem_update');
    Route::get('total_inv_value','Web\InventoryController@excelTotalInvValue')->name('total_inv_value');
    //Counting Unit
    ...
    Route::post('Count-Unit/update/spec/{id}', 'Web\InventoryController@updateUnitSpec')->name('count_unit_update_spec');
    ...
    Route::post('search_factory_po_list', 'Web\OrderController@searchFactoryPoList')->name('search_factory_po_list');
    ...
    Route::get('export-factorypolist/{from}/{to}/{type}', 'Web\OrderController@factoryPoExport')->name('export-factorypolist');
    ...
    Route::get('export-receivehistory/{from}/{to}/{id}', 'ExportController@receivableHistoryExport')->name('receivablehistoryexport');

    Route::get('export-payhistory/{from}/{to}/{id}', 'ExportController@payableHistoryExport')->name('payablehistoryexport');
    ...
    Route::post('facebook/store',  'Web\AdminController@facebook_store')->name('facebook_store');
    // Route::post('facebook_edit/{id}', 'Web\AdminController@facebook_edit')->name('facebook_edit');
    Route::post('facebook/create', 'Web\AdminController@facebook_create')->name('facebook_create');
    Route::post('facebook/update/{id}', 'Web\AdminController@facebook_update')->name('facebook_update');
    Route::post('facebook/delete', 'Web\AdminController@facebook_delete')->name('facebook_delete');

    //youtube_link
    Route::get('youtube', 'Web\AdminController@youtube_index')->name('youtube_index');
    Route::post('youtube/store',  'Web\AdminController@youtube_store')->name('youtube_store');
    Route::post('youtube/create', 'Web\AdminController@youtube_create')->name('youtube_create');
    Route::post('youtube/update/{id}', 'Web\AdminController@youtube_update')->name('youtube_update');
    Route::post('youtube/delete', 'Web\AdminController@youtube_delete')->name('youtube_delete');

    //Promotion_photo
    Route::get('promotionphoto', 'Web\AdminController@promotionphoto_index')->name('promotionphoto_index');
    Route::post('promotionphoto/store',  'Web\AdminController@promotionphoto_store')->name('promotionphoto_store');
    Route::post('promotionphoto/create', 'Web\AdminController@promotionphoto_create')->name('promotionphoto_create');
    Route::post('promotionphoto/update/{id}', 'Web\AdminController@promotionphoto_update')->name('promotionphoto_update');
    Route::post('promotionphoto/delete', 'Web\AdminController@promotionphoto_delete')->name('promotionphoto_delete');
    ...
    Route::post('hotcheckon-ajax', 'Web\StockController@hotCheckOnAjax')->name('hotcheckon-ajax');
    // Set Date Discount
    ...
    Route::get('export_itemadjust/{from}/{to}', 'Web\StockController@exportitemadjustLists')->name('export_itemadjust');
    ...
    Route::get('/fabric-delete/{id}', [\App\Http\Controllers\FabricController::class, 'delete'])->name('fabric.delete');
    ...
    Route::get('/colour-delete/{id}', [\App\Http\Controllers\ColourController::class, 'delete'])->name('colour.delete');
    //    Size
    ...
    Route::get('/size-delete/{id}', [\App\Http\Controllers\SizeController::class, 'delete'])->name('size.delete');
    //    Gender
    ...
    Route::get('/gender-delete/{id}', [\App\Http\Controllers\GenderController::class, 'delete'])->name('gender.delete');
});
...
//Sale Customers Export
Route::get('/saleCustomerExport', "Web\AdminController@saleCustomerExport");
//Order Customers Export
Route::get('/orderCustomerExport', "Web\AdminController@orderCustomerExport");
